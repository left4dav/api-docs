...
export interface ApiHttpResponseHttpResponse extends Schema.CollectionType {
  collectionName: 'http_responses';
  info: {
    singularName: 'http-response';
    pluralName: 'http-responses';
  ...
  attributes: {
    title: Attribute.String;
    color: Attribute.Enumeration<['Green', 'Orange', 'Red']> &
      Attribute.Required &
...
export interface ApiParameterParameter extends Schema.CollectionType {
  ...
  attributes: {
    ...
    usage: Attribute.Enumeration<
      ['optional', 'required', 'required if', 'deprecated']
    > &
      Attribute.Required &
      Attribute.DefaultTo<'required'>;
    usageDescription: Attribute.Blocks;
    type: Attribute.Enumeration<
      ['string', 'array', 'object', 'timestamp', 'integer', 'float', 'boolean']
    > &
      Attribute.Required &
    ...
    subparameter: Attribute.Relation<
      'api::parameter.parameter',
      'manyToOne',
      'api::parameter.parameter'
    >;
    subparameters: Attribute.Relation<
      'api::parameter.parameter',
      'oneToMany',
      'api::parameter.parameter'
    >;
    parameterRules: Attribute.Relation<
      'api::parameter.parameter',
      'oneToMany',
...
export interface ApiParameterRuleParameterRule extends Schema.CollectionType {
  collectionName: 'parameter_rules';
  info: {
    singularName: 'parameter-rule';
    pluralName: 'parameter-rules';
    displayName: 'Parameter Rule';
    description: '';
  };
  options: {
    draftAndPublish: true;
...
export interface ApiSdkMethodSdkMethod extends Schema.CollectionType {
  collectionName: 'sdk_methods';
  info: {
    singularName: 'sdk-method';
    pluralName: 'sdk-methods';
    displayName: 'SdkMethod';
    description: '';
  };
  options: {
    draftAndPublish: true;
  ...
  attributes: {
    ...
    language: Attribute.Enumeration<
      ['REST', 'PHP', 'NodeJS', 'NodeJS TS', 'Ruby', 'Java', 'Python', '.Net']
    > &
      Attribute.Required &
      Attribute.DefaultTo<'REST'>;
...
declare module '@strapi/types' {
  export module Shared {
    export interface ContentTypes {
      ...
      'api::http-response.http-response': ApiHttpResponseHttpResponse;
      'api::parameter.parameter': ApiParameterParameter;
      'api::parameter-rule.parameter-rule': ApiParameterRuleParameterRule;
      'api::sdk-method.sdk-method': ApiSdkMethodSdkMethod;
    }
  }
}
